...
%	  	align=center, 
	...
	%MANUALLY SET F NUMBER
	set function/.style={
		content/.wrap 2 pgfmath args={\textbf{F3} ##2}{n()}{content()},
		name/.wrap pgfmath arg={f##1}{n()},
		s sep=1cm,
		tree node
	},
	set concept/.style={
		content/.wrap 3 pgfmath args={\textbf{C3\alphalph{##2}} ##3}{n("!u")}{n()}{content()},
	...
	% MANUALLY CHANGE SFLABEL
	my sflabel/.style n args={2}{
		label={[align=left,text width=4cm,yshift=0.1cm] {\textbf{Sub-Functions (C3\alphalph{#2})}}},
	},
